    ...
    <div class="flex flex-stretch items-center">
      <div class="w-56 items-center flex">
          <a href="{{ route('index') }}">
            ...
            alt="WorkSpace | Fulfill your house with beautiful furniture"
          />
      ...
      <div class="w-auto">
        ...
        >
          <li class="mx-3 py-6 md:py-0">
            <a href="#" class="{{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }}"
              >Showcase</a
            >
          </li>
          <li class="mx-3 py-6 md:py-0">
          ...
          @auth
          <li class="mx-3 py-6 md:py-0">
            <a href="{{ route('dashboard.index') }}" class="{{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }}"
              >Dashboard</a
            >
          </li>
          @endauth
          ...
          @guest
          <li class="mx-3 py-6 md:py-0">
            <a href="{{ route('login') }}" class="{{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }}"
              >Login</a
            >
          </li>
          <li class="mx-3 py-6 md:py-0">
            <a href="{{ route('register') }}" class="{{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }}"
              >Register</a
            >
          </li>
